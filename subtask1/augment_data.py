    ...
    for i in range(n_samples):
        ...
        for aug_idx in range(augment_factor):
            ...
            for frame_idx in range(seq_len):
                frame_keypoints = sample[frame_idx].reshape(21, 3)

                # 应用变换
                transformed = apply_random_transform_single(
                    frame_keypoints,
                ...
                augmented_sample.append(transformed.reshape(63))
...
def apply_random_transform_single(keypoints, rot_x=0, rot_y=0, rot_z=0, scale=1.0,
                                translate_x=0, translate_y=0, translate_z=0, noise_std=0):
    """对单个帧应用指定的变换"""
    transformed = keypoints.copy()
...
if __name__ == "__main__":
    ...
    print("开始数据增强...")
    # 每个样本生成4个增强版本，总共5倍数据
    augmented_X, augmented_y = augment_dataset(X, y, augment_factor=4)
